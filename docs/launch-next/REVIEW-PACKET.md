...
| P1-01 | Product content/pricing | **Factual text fixed; intent staged.** Fresh eight variants retain $149.95 standard/$174.95 medal. $25 delta matches text and Gallery selection. Merchant still must approve intended surcharge and 25OFF scope; no price/discount changed. |
| P1-02 | Policies/shipping/content | **Staged for necessary review.** Existing 7/14-day damage and processing conflicts unresolved; new graphic says 8–10 days. Do not select a production capability from conflicting claims. Prepared exception in prior packet; checkout eligibility untested. |
| P1-03 | Policies/mailbox | **Staged; delivery access/identity needed.** No monitored support mailbox or response expectation verified. Policy placeholder replacement awaits tested mailbox, not merely a plausible address. |
| P1-04 | Product/policy | **Partial inherited fix; staged cancellation decision.** Existing custom-made change-of-mind exclusion disclosed. Before/after-approval cancellation terms require merchant decision; preserve earlier order terms. |
...
| P1-06 | Policy/intake/storage | **Staged for actual practice.** No retention period/deletion automation invented. Prepared private-route exclusion and notice outline await access/retention/deletion decisions and provider verification. |
